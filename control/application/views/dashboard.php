           ...
           <div class="row row-group m-0">
             <div class="col-12 col-xl-6">
              <div class="text-center">
               ...
               <hr>
               <p class="mb-0">Satisfied : <span class="badge badge-pill badge-secondary float-right" style="background-color:#d13adf;">65%</span></p>
               <p class="mb-0">Unsatisfied : <span class="badge badge-pill float-right" style="background-color: rgba(209, 58, 223, 0.40);">35%</span></p>
             </div>
             <div class="col-12 col-xl-6">
              <div class="text-center">
                <span class="donut" data-peity='{ "fill": ["#ff8800", "rgba(251, 165, 64, 0.40)"]}'>3/5</span>
               </div>
               <hr>
               <p class="mb-0">Very Satisfied : <span class="badge badge-pill badge-warning float-right">65%</span></p>
               <p class="mb-0">Very Unsatisfied : <span class="badge badge-pill badge-light float-right" style="background-color: rgba(251, 165, 64, 0.40);">35%</span></p>
             </div>
           </div>
