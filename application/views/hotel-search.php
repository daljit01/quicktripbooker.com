                                    ...
                                    <div class="row">
                                      <div class="col-sm col-6">
                                        ...
                                        <label class="level-home-form">City / Hotel / Area</label>
                                         ...
                                         -->
                                         <input type="text" class="hoteldestination quote_frm form-control routeorigincode" autocomplete="off" id="hotel_city" name="hotel_city" placeholder="City / Hotel / Area">
                                      ...
                                      <div class="col-sm col-6">
                                          <div class="form-group form-style">
                                              ...
                                              <input type="text" class="form-control quote_frm" autocomplete="off" name="date_to" id="date_to" placeholder="Date To">
                                          </div>
                                      </div>
