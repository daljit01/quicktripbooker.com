                                    ...
                                    <div class="row">
                                      <div class="col-12">
                                          <div class="form-group form-style">
                                            <label class="level-home-form">Ciudad / Hotel / Área</label>
                                         ...
                                         -->
                                          <div class="hotel_inputbox">
                                            <input type="text" class="hoteldestination quote_frm form-control routeorigincode" autocomplete="off" id="hotel_city" name="hotel_city" placeholder="Ciudad / Hotel / Área" required>
                                      ...
                                      <div class="col-12">
                                          <div class="form-group form-style">
                                                ...
                                                <label class="level-home-form">Comprobar en la fecha</label>
                                                <div class="hotel_inputbox">
                                                    <input type="text" class="quote_frm form-control" autocomplete="off" name="date_from" id="date_from" value="" placeholder="Fecha de" required> 
                                      ...
                                      <div class="col-12">
                                          <div class="form-group form-style">
                                                ...
                                                <label class="level-home-form">Echa un vistazo a la fecha</label>
                                                <div class="hotel_inputbox">
                                                  <input type="text" class="form-control quote_frm" autocomplete="off" name="date_to" id="date_to" placeholder="Fecha hasta" required>
                                                  <i class="fa-solid fa-calendar-days"></i>
                                                </div>  
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12">
                                          ...
                                          <button class="btn btn-secondary home-search-btn w-100 search-hotel-btn">Buscar hotel</button>
                                          </div>
                                      </div>
                                    </div>
