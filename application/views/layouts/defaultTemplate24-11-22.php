...
<div class="layer"></div>
	...
	<!-- Header================================================== -->
	<header class="<?php echo !empty($userheader) ? $userheader : ""; ?>">
		...
		<div class="container-fluid">
            <div class="row align-items-center">
                ...
                <a href="<?php echo base_url('login'); ?>"><i class="fa fa-user-o signupmenu d-block d-lg-none float-right text-white mr-5"></i></a> <a class="cmn-toggle-switch cmn-toggle-switch__htx open_close" href="#">  <span>Menu mobile</span></a>
                    <div class="main-menu">
                        <div id="header_menu">
				...
				<div class="col-sm-3 col-12">
					...
					<h3>Top Airlines</h3>
                       <ul>
						...
						<li><a href="<?php echo base_url('delta-airlines'); ?>">Delta Airlines</a></li>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 col-12">
						...
						<p class="copy-right text-center"><b>© Copyright <?php echo date("Y"); ?> <span class="colorred"><?php echo $this->Site_Model->websitename; ?></span> | DBA - Infinity Travels. All Rights Reserved.</b></p>
                    </div>

					<div class="col-sm-6 col-12 text-lg-right text-center">
					<ul class="mt-3">
						
						<li class="d-inline-block pr-3"><a href="<?php echo base_url('InfinityIATA2022.pdf'); ?>" target="_blank"><span><img src="<?php echo base_url('assets/images/iataabta1.png');?>" width= "100px"  alt="Logo"></span></a></li>
						<li class="d-inline-block"><a href="<?php echo base_url('INFINITY_TRAVELS_DBA.PDF'); ?>" target="_blank"><span><img src="<?php echo base_url('assets/images/DBA.png');?>"  width= "100px" alt="Logo"></span></a></li>
					</ul>
				</div>
    ...
    <div class="ph-fixed d-lg-none d-block text-center pt-3 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
